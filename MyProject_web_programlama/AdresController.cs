...
namespace MyProject_web_programlama
{
    public class AdresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ilce,Il,Satir1,Satir2")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ilce,Il,Satir1,Satir2")] Adres adres)
        {
            if (id != adres.Id)
            {
                return NotFound();
